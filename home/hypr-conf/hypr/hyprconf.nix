{
  wayland.windowManager.hyprland.settings = {
    ...
    workspace = [
      ...
      "2, on-created-empty:[tiled] firefox, monitor:DP-2"
      "3, on-created-empty:[tiled] discord, monitor:DP-2"
      "4, on-created-empty:[tiled] code /home/liperium/nix-conf, monitor:DP-1"
      "5, on-created-empty:[tiled] steam, monitor:DP-1"
    ];
